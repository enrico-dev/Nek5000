...
//! \return Error value
int nek_get_global_elem_centroid(ptrdiff_t global_elem, double* x, double* y, double* z);
...
int nek_get_local_elem_centroid(ptrdiff_t local_elem, double* x, double* y, double* z);
...
//! \return  Error value
int nek_get_local_elem_volume(ptrdiff_t local_elem, double* volume);
...
int nek_get_local_elem_temperature(ptrdiff_t local_elem, double* temperature);

//! Get the global element ID for a given local element
//! \param local_elem  A local element ID
//! \return The corresponding global element ID
ptrdiff_t nek_get_global_elem(ptrdiff_t local_elem);
...
ptrdiff_t nek_get_local_elem(ptrdiff_t global_elem);
...
//! \return Error code
int nek_set_heat_source(ptrdiff_t local_elem, double heat);
